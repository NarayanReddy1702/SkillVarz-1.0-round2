...
const Home = () => {
  return (
    <div className='min-h-screen bg-black text-white flex items-center  gap-y-6 justify-center flex-col px-4'>
         <div><h1 className='font-["font-2"] text-6xl md:text-[9vw] mt-26 md:mt-24'>VisuaLab,</h1></div>
         <div className='font-[font-1] flex justify-end  md:w-[32%] '><h1 className='text-3xl md:text-5xl'>Design Web Studio</h1></div>
